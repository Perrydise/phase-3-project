            ...
            <div className="car-item-display" >
                <ul>
                    ...
                    <li key={id+"-model"}>
                        ...
                        <input type="text" name="model" readOnly={showForm} value={formModel} onChange={handleModel}/>
                    </li>
                    <li key={id+"-color"}>
                        <label for="color">Color: </label>
                        <input type="text" name="color" readOnly={showForm} value={formColor} onChange={handleColor}/>
                    </li>
                    <li key={id+"-year"}>
